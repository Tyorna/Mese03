var giocatore3 = Math.floor(Math.random() * (100 - 1) + 1);
var giocatore4 = Math.floor(Math.random() * (100 - 1) + 1);
var estratto2 = Math.floor(Math.random() * (100 - 1) + 1);
window.addEventListener('load', function () {
    console.log("Giocatore1: ".concat(giocatore3));
    console.log("Giocatore2: ".concat(giocatore4));
    console.log("Numero estratto: ".concat(estratto2));
    switch (true) {
